...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Programming Languages', description: 'C, C++, Python, JavaScript, TypeScript, PHP, Scala, R, Dart' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'BSc Computer Science - University of Colombo (2022-Present)' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Built 10+ projects including e-commerce, chat apps, and ML models' }
];
